...
public class SendImageService extends IntentService {
    ...
    public SendImageService(String name) {
		super(name);
...
public SendImageService(){
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (intent.getAction().equals(ACTION_SEND_FILE)) {
            ...
            try {
                Log.d("client socket", "Opening client socket - ");
                socket.bind(null);
                socket.connect((new InetSocketAddress(host, port)), SOCKET_TIMEOUT);

                Log.d("client socket connected", "Client socket - " + socket.isConnected());
                ...
                Log.d("harsh", "Client: Data written");
            } catch (IOException e) {
